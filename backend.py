...
# Set probabilities for anomaly patterns
consecutive_anomaly_prob = 0.05
single_anomaly_prob = 0.07
fall_trigger_prob = 0.10
...
def stream_data_for_all_patients():
    ...
    while True:
        ...
        for patient_id, ranges in enumerate(individual_ranges, start=1):
            if high_risk_mode:
                ...
                if anomaly_block > 0:
                    ...
                    data = generate_normal_data(ranges)
                    fall_risk_counter = 0
